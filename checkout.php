                                    ...
                                    <div class="accordion__body">
                                        <div class="paymentinfo">
                                            <div class="single-method">
                                                Credit Card <input type="radio" name="payment_type" value="creditcard" required/>
												&nbsp;&nbsp;PayPal <input type="radio" name="payment_type" value="paypal" required/>
                                            </div>
                                            <div class="single-method">
